...
using System.Data;
using System.Configuration; // para usar el archivo XML App.config donde hemos guardado la cadena de conexión
...
namespace PROYECTO_FINAL_NUEVO
{
    public class GestorDeBaseDeDatos
    {
        ...
        public GestorDeBaseDeDatos()
        {
            ...
            myConnectionString = ConfigurationManager.AppSettings.Get("MiCadenaDeConexion");
